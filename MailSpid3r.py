...
print "*                                                                 *"
print "*\033[1;32;40m +-+-+-+-+ | +-+-+-+-+-+-+                                       *"
print "*\033[1;32;40m |M|a|i|l|   S|p|i|d|3|r |                                       *"
print "*\033[1;32;40m +-+-+-+-+ | +-+-+-+-+-+-+                                       *"
print "*\033[1;32;40m                                                                 *"
print "*\033[1;32;40m MailSpid3r Ver. 1.0.1b (beta version)                           *"
print "*\033[1;32;40m Coded by Srabon Khan                                            *"
print "*\033[1;32;40m maniac.naiem@gmail.com                                          *"
print "*\033[1;32;40m                                                                 *"
print "*\033[1;32;40m******************************************************************\n\n"
...
def usage():
    ...
    print "Usage: MailSpid3r options \n"
    print "       -d: Domain to search or company name"
    print """       -b: data source: baidu,bing,google,linkedin,twitter,yahoo\n"""
    ...
    print "        " + comm + " -d microsoft.com -b bing "
    print "        " + comm + " -d apple.com -b yahoo -l 500 -s 300\n"
...
def start(argv):
    ...
    for opt, arg in opts:
        if opt == '-l':
            ...
            if engine not in ("baidu", "bing", "crtsh","bingapi","dogpile", "google", "googleCSE","virustotal", "googleplus", "google-profiles","linkedin", "pgp", "twitter", "vhost", "yahoo","netcraft","all"):
                usage()
                print "Invalid search engine, try with: baidu,bing,google,linkedin,twitter,yahoo,"
                sys.exit()
            else:
                pass
    if engine == "google":
    ...
    if filename != "":
        ...
        try:
            ...
            file.write('<?xml version="1.0" encoding="UTF-8"?><MailSpid3r>')
            for x in all_emails:
